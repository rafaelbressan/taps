-- A mesma instalação, mas que NUNCA rodou checkSixDecimals() nem
-- addTxHashFields(): total é DECIMAL(20,2) e não existe coluna de hash.
-- Os valores entram com seis casas de propósito — quem trunca para duas é o
-- H2, que é exatamente o que aconteceu no banco desses bakers.
...
INSERT INTO payments (BAKER_ID, CYCLE, DATE, RESULT, TOTAL) VALUES
('tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb', 499, parsedatetime('01-15-2024','MM-dd-yyyy'), 'paid', 125.543210),
('tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb', 500, parsedatetime('01-18-2024','MM-dd-yyyy'), 'rewards_pending', 0.000000);

INSERT INTO delegatorsPayments (BAKER_ID, CYCLE, ADDRESS, DATE, RESULT, TOTAL) VALUES
('tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb', 499, 'tz1RLNfVUUvzCcAkTHsFrEZH1Kg7cCbNNy4M', parsedatetime('01-15-2024','MM-dd-yyyy'), 'applied', 120.000000),
('tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb', 499, 'tz1burnburnburnburnburnburnburjAYjjX', parsedatetime('01-15-2024','MM-dd-yyyy'), 'applied', 0.003970),
('tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb', 499, 'tz1gjaF81ZRRvdzjobyfVNsAeSC6PScjfQwN', parsedatetime('01-15-2024','MM-dd-yyyy'), 'failed', 5.539240);
